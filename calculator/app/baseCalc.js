app.controller('baseCalcController', function($scope, outputFactory, BaseButtonsFactory) {
    $scope.outputFactory = outputFactory;
    outputFactory.outputFactory = outputFactory;
    
    $scope.BaseButtonsFactory = BaseButtonsFactory;
    BaseButtonsFactory.BaseButtonsFactory = BaseButtonsFactory;
    
    BaseButtonsFactory.buttons().then(function(data) {
		$scope.buttons = data;        
	});
